...
Regards,<br>${d.managerName}<br>Kneuralabs</div>`
  ...
  function updatePreview() {
    ...
    if (!tpl) return;
    const sysNote = `<div class="letter-sysnote">System-generated by Kneuralabs — valid without a physical signature and carrying the same authority as an originally signed letter.</div>`;
